...
import (
  ...
  "kidiyoor.io/family-tree/pkg/members/angara/narsi/manjunath"
)
...
var (
  ...
  Narsi = types.Member{
    Name: "Narsi",
    Children: []*types.Member{&girija.Girija, &kamala.Kamala, &manjunath.Manjunath, &sharada.Sharada, &sundari.Sundari, &yashoda.Yashoda, },
    Gender: types.Female,
  }
)
